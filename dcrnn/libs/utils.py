...
def load_dataset(dataset_dir, batch_size, test_batch_size=None, **kwargs):
    ...
    #
    # data1['train_loader'] = data_loader(x_train, y_train, batch_size, shuffle=True, drop_last=True)
    # data1['val_loader'] = data_loader(x_val, y_val, batch_size, shuffle=False, drop_last=True)
    # data1['test_loader'] = data_loader(x_test, y_test,batch_size, shuffle=False, drop_last=True)
    data1['train_loader'] = DataLoader(x_train, y_train, batch_size, shuffle=True)
    data1['val_loader'] = DataLoader(x_val, y_val, batch_size, shuffle=False)
    data1['test_loader'] = DataLoader(x_test, y_test, batch_size, shuffle=False)
    data1['scaler'] = scaler
