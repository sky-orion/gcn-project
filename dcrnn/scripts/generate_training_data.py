...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="/devdata/zhaohaoran/airspacedata")
    parser.add_argument("--traffic_df_filename", type=str, default="/devdata/zhaohaoran/adj_mx_geo_126.csv")
