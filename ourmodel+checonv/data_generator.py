...
def generate_train_val_test(args,gen=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="/data4/zhaohaoran/aerodata/unpermutation")
    args = parser.parse_args()
    train, val, test, scaler = generate_train_val_test(args,gen=True)
