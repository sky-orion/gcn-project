...
def get_args():
    ...
    parser.add_argument('--checkpoint', type=str,default="./checkpoints/log_07311449/best_model_07311449.pth")
    #default="./checkpoints/log_07261223/best_model_07261223.pth" 140
