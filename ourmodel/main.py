...
def get_args():
    ...
    # data args
    parser.add_argument("--feature_data_path", type=str, default="/data4/zhaohaoran/aerodata/all_day_feature_single_daytime.npy")
    parser.add_argument("--adj_data_path", type=str, default="/data4/zhaohaoran/aerodata/adj_mx_geo_126.csv")
    parser.add_argument("--adj_type", type=str, default="doubletransition")
    parser.add_argument('--n_vertex', type=int, default=126)
    parser.add_argument("--seq_length_x", type=int, default=60)
    parser.add_argument("--seq_length_y", type=int, default=60)
