...
def get_args():
    ...
    parser.add_argument("--feature_data_path", type=str,
                        default="/devdata/zhaohaoran/all_day_feature_single_daytime.npy")
    parser.add_argument("--adj_data_path", type=str, default="/devdata/zhaohaoran/adj_mx_geo_126.csv")
    ...
    parser.add_argument('--nonuse_graph_learning', dest='use_graph_learning', action='store_false',
                        default=True)  # 自适应邻居矩阵
    ...
    parser.add_argument('--checkpoint',  default="./checkpoints/log_07211320/best_model_07211320.pth",type=str)

    parser.add_argument('--resume', type=bool, default=False)
    parser.add_argument('--resumedir', type=str, default=" ./checkpoints/log_07211320/best_model_07211320.pth")
...
def main():
    ...
    if args.multi_graph:
        adaptive_mat, adj_mats = load_multi_adj('data/adj_mx_geo_126.csv', 'data/adj_mx_flow_126.csv',
    ...
    optimizer = optim.Adam(params=model.parameters(), lr=args.lr, eps=1.0e-8, weight_decay=args.weight_decay,
                           amsgrad=False)
